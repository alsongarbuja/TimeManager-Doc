...
The dashboard application is built using ASP.NET Core's **Model-View-Controller (MVC)** architectural pattern. By enforcing a strict separation of concerns, the pattern decouples data management, business logic, and the user interface. This separation ensures our application remains modular, highly testable, and clean as the system grows.
